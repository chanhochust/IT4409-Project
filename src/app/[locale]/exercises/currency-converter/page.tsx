    ...
    <div className="mx-auto max-w-xl p-6">
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <div className="sm:col-span-1">
          ...
          <select value={from} onChange={handleFromChange} className="w-full rounded-md border border-gray-300 px-3 py-2">
      ...
      {error && (
        <div className="mb-3 rounded-md border border-red-300 bg-red-50 p-3 text-red-700">
          {error}
        </div>
      )}
