      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        {loading ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[...Array(10)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl h-[350px] animate-pulse border border-gray-100" />
            ))}
          </div>
        ) : (
          <>
            ...
            {results.length === 0 ? (
              <div className="bg-white rounded-3xl p-16 flex flex-col items-center justify-center shadow-sm border border-white">
                ...
                <button 
                  ...
                  className="mt-6 bg-blue-600 text-white px-8 py-2.5 rounded-full font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-100"
                >
                  Quay lại trang chủ
                </button>
              </div>
