...
import { FaBox, FaShoppingBasket, FaUsers, FaMoneyBillWave, FaArrowUp, FaArrowDown, FaLink, FaChartBar } from 'react-icons/fa';
  ...
  return (
    <div className="admin-main-wrapper">
      ...
      <div className="dashboard-stats-grid">
        ...
        <StatCard icon={FaBox} title="Tổng sản phẩm" value="2,100" change="Đang hoạt động" color="#ffc107" trend="neutral" />
      </div>

      {/*  Khu vực Biểu đồ (Placeholder) */}
      <div style={{backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', marginTop: '20px'}}>
        <h2 style={{fontSize: '1.2rem', fontWeight: '600', color: '#343a40', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px'}}>
          <FaChartBar style={{color: '#007bff'}} /> Báo cáo Doanh thu hàng tháng
        </h2>
        <div style={{height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px dashed #ced4da', borderRadius: '4px', color: '#999'}}>
