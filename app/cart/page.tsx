  ...
  return (
    <div className="cart-page">
      <div className="cart-empty">
        <Image src="/empty-cart.png" width={300} height={300} alt="Giỏ hàng" />
        <div className="cart-text">
          <p>
            Vui lòng <Link href="/signin" className="login-link">đăng nhập</Link> để xem giỏ hàng
          </p>
          <span className="dang-ky">
            Chưa có tài khoản? <Link href="/signup" className="login-link">Đăng ký ngay</Link>
          </span>
        </div>
      </div>
    </div>
